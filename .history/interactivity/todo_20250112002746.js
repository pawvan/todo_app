...
function addTask() {
  ...
  if (taskText !== "") {
    ...
    const createdAtWrapper = document.createElement('div');
    createdAtWrapper.classList.add('wrapper');
    ...
    createdAtWrapper.appendChild(span);
    createdAtWrapper.appendChild(spanofTask);
    ...
    li.appendChild(createdAtWrapper);
