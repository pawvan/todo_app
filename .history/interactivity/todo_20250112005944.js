...
function addTask() {
  ...
  if (taskText !== "") {
    ...
    ompleteCheckbox.style.borderColor = getRandomColor();  // Apply border color
completeCheckbox.style.borderWidth = '2px'; // Ensure border is visible
completeCheckbox.style.borderStyle = 'solid'; // Add solid border style
completeCheckbox.style.padding = '5px';  // Optional for better appearance
    completeCheckbox.style.borderColor=getRandomColor()  +'!important'
