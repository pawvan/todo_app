...
function addTask() {
  ...
  if (taskText !== "") {
    ...
    completeCheckbox.style.display = 'none';  // Hide default checkbox

    const customCheckbox = document.createElement('div');
    customCheckbox.classList.add('radio-wrapper');
    customCheckbox.style.backgroundColor = getRandomColor();  // Random color
...
function loadTasks() {
  ...
  tasks.forEach((task) => {
    ...
    const customCheckbox = document.createElement('div');
    customCheckbox.classList.add('radio-wrapper');
    customCheckbox.style.backgroundColor = getRandomColor();
